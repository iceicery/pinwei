        ...
        <ul className="before__box">
          <li className="before__item">
            ...
            <div className="before__item-textbox">
              <h3 className="before__item-title lobster">
                I was a statistical analyst.
              </h3>
              <p>
                I worked at{' '}
                <a
          ...
          <li className="before__item">
            ...
            <div className="before__item-textbox">
              <h3 className="before__item-title lobster">
                I was a physics lover.
              </h3>
              <p>
                I was a research assistant of applied physics at{' '}
                <a
                ...
                I simulated the best shape for the{' '}
                <a
                ...
                probe based on fundamental electromagnetism and finite element
                analysis. I also produced the probe using chemical etching and
                focus iron Bean.
              </p>
            </div>
          </li>
